...
from cliport.agents.transporter_lang_goal import TwoStreamClipFilmLingUNetLatTransporterAgent, \
    TwoStreamClipLingUNetLatTransporterAgentReduce, \
    TwoStreamClipLingUNetLatTransporterAgentReducePretrained
...
from cliport.agents.transporter_lang_goal import \
    TwoStreamClipLingUNetLatTransporterAgentReduceOneStream
