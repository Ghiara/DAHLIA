...
from cliport.models.streams.two_stream_attention_lang_fusion import \
    TwoStreamAttentionLangFusionLat, TwoStreamAttentionLangFusionLatReduce
from cliport.models.streams.two_stream_transport_lang_fusion import TwoStreamTransportLangFusion, \
    TwoStreamTransportLangFusionLatReduce, TwoStreamTransportLangFusionLatPretrained18
from cliport.models.streams.two_stream_transport_lang_fusion import TwoStreamTransportLangFusionLat
from cliport.models.streams.two_stream_transport_lang_fusion import \
    TwoStreamTransportLangFusionLatReduceOneStream
...
class TwoStreamClipLingUNetLatTransporterAgent(
    TwoStreamClipLingUNetTransporterAgent):  # This is our model
    def __init__(self, name, cfg, train_ds, test_ds):
        super().__init__(name, cfg, train_ds, test_ds)
...
class TwoStreamClipLingUNetLatTransporterAgentReduce(
    TwoStreamClipLingUNetTransporterAgent):  # This is our model
    def __init__(self, name, cfg, train_ds, test_ds):
        super().__init__(name, cfg, train_ds, test_ds)
...
class TwoStreamClipLingUNetLatTransporterAgentReduceOneStream(
    TwoStreamClipLingUNetTransporterAgent):  # This is our model
    def __init__(self, name, cfg, train_ds, test_ds):
        super().__init__(name, cfg, train_ds, test_ds)
...
class TwoStreamClipLingUNetLatTransporterAgentReducePretrained(
    TwoStreamClipLingUNetTransporterAgent):  # This is our model
    def __init__(self, name, cfg, train_ds, test_ds):
        super().__init__(name, cfg, train_ds, test_ds)
