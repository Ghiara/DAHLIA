...
from gensim.utils import set_gpt_model, format_finetune_prompt
...
def main(cfg):
    ...
    #
    cfg['model_output_dir'] = os.path.join(cfg['output_folder'],
                                           cfg['prompt_folder'] + "_" + cfg.target_model)
    if 'seed' in cfg:
        ...
        if 'new_finetuned_model' in cfg or 'gpt-3.5-turbo' in cfg.target_model:
            ...
            response = openai.ChatCompletion.create(
                ...
                messages=[{"role": "system",
                           "content": "You are an AI in robot simulation code and task design."},
